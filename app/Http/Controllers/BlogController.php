...
class BlogController extends Controller
{
    private $blogs = [
        ...
        6 => [
            ...
            'date' => '2/25/2022',
            'subtitle' => 'Classes',
            'content' => 'You learned from the previous chapter that C# is an object-oriented programming language. Everything in C# is associated with classes and objects, along with its attributes and methods. For example: in real life, a car is an object.',
        ],
        7 => [
            'blogtitle' => 'Python',
            'date' => '2/26/2022',
